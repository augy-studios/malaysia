...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        web_app_url=_optional("WEB_APP_URL", "https://malaysia.uwuapps.org/bus/"),
        database_path=data_dir / _optional("DATABASE_NAME", "buses.sqlite3"),
        session_path=data_dir / _optional("SESSION_NAME", "buses-bot"),
        ...
        nearby_radius_metres=_int_env("NEARBY_RADIUS_METRES", 1200),
