"""Time handling for Malaysian rail schedules.
...
rejected. KTMB's intercity and ETS trips use this regularly.
"""
...
# Hours are allowed up to three digits so GTFS "25:10:00" style values parse.
...
def format_wait(seconds: float) -> str:
    """Phrase how long until a departure, for 'next train' style answers."""
...
def parse_gtfs_date(value: str) -> date | None:
    """Parse a GTFS YYYYMMDD date from calendar.txt or calendar_dates.txt."""
